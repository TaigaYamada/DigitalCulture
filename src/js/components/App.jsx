    ...
    <div className='app'>
      ...
      <div className='container'>
        <SimpleBar className='container__scroll'>
          ...
          <Subheading id='0'>Subheading test</Subheading>
          <Bubble>
            Insert Cléa Part
          </Bubble>
          <Bubble>
          ...
          <Bubble left>
            This shift in platforms is to be understood as a
            {' '}
            <b>generational move</b>
            . Nobody is really willing to use Messenger anymore because it has now become too old.
          </Bubble>
          <Bubble>
